...
public class ClientFrame extends JFrame {
    ...
    private void initialize() {
        ...
        this.getContentPane().add(btnShowAllMy);
        ...
        this.getContentPane().add(lblCreateAccount);
        ...
        this.getContentPane().add(lblCustumerId);
        ...
        this.getContentPane().add(lblDeleteAccount);
        ...
        this.getContentPane().add(lblTarakonesh);
