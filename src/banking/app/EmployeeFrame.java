...
public class EmployeeFrame extends JFrame {
    ...
    private void initialize() {
        ...
        this.getContentPane().add(lblMoshtari);
        ...
        this.getContentPane().add(btnShowAll);

        JTextPane textPane_1 = new JTextPane();
        textPane_1.setToolTipText("");
        textPane_1.setBounds(402, 89, 354, 271);
        this.getContentPane().add(textPane_1);
        ...
        this.getContentPane().add(lblAccounts);
        ...
        this.getContentPane().add(textPane_2);

        JTextPane textPane_3 = new JTextPane();
        textPane_3.setBounds(326, 519, 132, 25);
        this.getContentPane().add(textPane_3);
        ...
        this.getContentPane().add(textPane_4);
        ...
        this.getContentPane().add(lblDestinationAccountId);
        ...
        this.getContentPane().add(btnTransfer);
    }
}
